--
-- TAPI_WDX_ROLES_PMSN  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   WDX_ROLES_PMSN (Table)
--
CREATE OR REPLACE PACKAGE      tapi_wdx_roles_pmsn
IS
   /**
   -- # TAPI_WDX_ROLES_PMSN
   ...
   */
   ...
   SUBTYPE rolename IS wdx_roles_pmsn.rolename%TYPE;
   SUBTYPE pmsname IS wdx_roles_pmsn.pmsname%TYPE;
   SUBTYPE appid IS wdx_roles_pmsn.appid%TYPE;
   SUBTYPE created_by IS wdx_roles_pmsn.created_by%TYPE;
   SUBTYPE created_date IS wdx_roles_pmsn.created_date%TYPE;
   SUBTYPE modified_by IS wdx_roles_pmsn.modified_by%TYPE;
   SUBTYPE modified_date IS wdx_roles_pmsn.modified_date%TYPE;

   --Record type
   TYPE wdx_roles_pmsn_rt
   IS
      RECORD (
            rolename wdx_roles_pmsn.rolename%TYPE,
            pmsname wdx_roles_pmsn.pmsname%TYPE,
            appid wdx_roles_pmsn.appid%TYPE,
            created_by wdx_roles_pmsn.created_by%TYPE,
            created_date wdx_roles_pmsn.created_date%TYPE,
            modified_by wdx_roles_pmsn.modified_by%TYPE,
            modified_date wdx_roles_pmsn.modified_date%TYPE,
            hash               hash_t,
            row_id            VARCHAR2(64)
      );
   --Collection types (record)
   TYPE wdx_roles_pmsn_tt IS TABLE OF wdx_roles_pmsn_rt;
   ...
   e_del_failed      EXCEPTION; --The delete operation failed
    ...
    --    | -- | -- | --
    --    |p_rolename | wdx_roles_pmsn.rolename%TYPE | must be NOT NULL
    --    |p_pmsname | wdx_roles_pmsn.pmsname%TYPE | must be NOT NULL
    --    |p_appid | wdx_roles_pmsn.appid%TYPE | must be NOT NULL
    --### Amendments
    --| When         | Who                      | What
    --|--------------|--------------------------|------------------
   ...
   RETURN varchar2;
    ...
    --## Function Name: RT
    --### Description:
    --       This is a table encapsulation function designed to retrieve information from the wdx_roles_pmsn table.
    --
    --### IN Paramters
    --    | Name | Type | Description
    --    | -- | -- | --
    ...
    --    | Name | Type | Description
    --    | -- | -- | --
    --    |     | wdx_roles_pmsn_rt |  wdx_roles_pmsn Record Type
    --### Amendments
    --| When         | Who                      | What
    --|--------------|--------------------------|------------------
    --|23-NOV-2015 12:03   | DBAX | Created
   ...
   /**
    ...
    --       This is a table encapsulation function designed to retrieve information
             from the wdx_roles_pmsn table while placing a lock on it for a potential
   ...
   FUNCTION rt_for_update (
    ...
    --  | Name | Type | Description
    --  | -- | -- | --
    --  |     | wdx_roles_pmsn_tt |  wdx_roles_pmsn Table Record Type
    --### Amendments
    --| When         | Who                      | What
    --|--------------|--------------------------|------------------
    --|23-NOV-2015 12:03   | DBAX | Created
   ...
   PIPELINED;
    ...
    --## Function Name: INS
    --### Description:
    --      This is a table encapsulation function designed to insert a row into the wdx_roles_pmsn table.
    --### IN Paramters
    --    | Name | Type | Description
    --    | -- | -- | --
    --   | p_wdx_roles_pmsn_rec | wdx_roles_pmsn_rt| wdx_roles_pmsn Record Type
    --### Return
    --    | Name | Type | Description
    --    | -- | -- | --
    --    | p_wdx_roles_pmsn_rec | wdx_roles_pmsn_rt |  wdx_roles_pmsn Record Type
   ...
   PROCEDURE ins (p_wdx_roles_pmsn_rec IN OUT wdx_roles_pmsn_rt);
    ...
    --## Function Name: UPD
    --### Description:
    --     his is a table encapsulation function designed to update a row in the wdx_roles_pmsn table.
    --### IN Paramters
    --    | Name | Type | Description
    --    | -- | -- | --
    --   | p_wdx_roles_pmsn_rec | wdx_roles_pmsn_rt| wdx_roles_pmsn Record Type
    ...
    --|23-NOV-2015 12:03   | DBAX | Created
    */
   PROCEDURE upd (p_wdx_roles_pmsn_rec IN wdx_roles_pmsn_rt, p_ignore_nulls IN boolean := FALSE);
    ...
    --|23-NOV-2015 12:03   | DBAX | Created
    */
   PROCEDURE upd_rowid (p_wdx_roles_pmsn_rec IN wdx_roles_pmsn_rt, p_ignore_nulls IN boolean := FALSE);

    /**
    --## Function Name: WEB_UPD
    --### Description:
    --      This is a table encapsulation function designed to update a row
            in the wdx_roles_pmsn table whith optimistic lock validation
    --### IN Paramters
    --  | Name | Type | Description
    --  | -- | -- | --
    --  | p_wdx_roles_pmsn_rec | wdx_roles_pmsn_rt| wdx_roles_pmsn Record Type
    ...
    --|23-NOV-2015 12:03   | DBAX | Created
    */
   PROCEDURE web_upd (p_wdx_roles_pmsn_rec IN wdx_roles_pmsn_rt, p_ignore_nulls IN boolean := FALSE);
    ...
    --|23-NOV-2015 12:03   | DBAX | Created
    */
   PROCEDURE web_upd_rowid (p_wdx_roles_pmsn_rec IN wdx_roles_pmsn_rt, p_ignore_nulls IN boolean := FALSE);

    /**
    --## Function Name: DEL
    --### Description:
    --       This is a table encapsulation function designed to delete a row from the wdx_roles_pmsn table.
    --### IN Paramters
    --    | Name | Type | Description
    --    | -- | -- | --
    --   |p_rolename | wdx_roles_pmsn.rolename%TYPE | must be NOT NULL
    ...
    * @return  wdx_roles_pmsn     Table Record Type 
    */

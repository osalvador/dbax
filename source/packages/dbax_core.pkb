...
AS
   ...
   BEGIN
      ...
      THEN
         ...
         --Recogemos el resultado de la ejecuci�n

         l_out       := dump_owa_page;


         --Only if is not null
         --A�adimos el resultado de la ejecucion a la variable resultado
         IF LENGTH (l_out) > 0
         THEN
            DBMS_LOB.COPY (l_result
                         , l_out
      ...
      --La funcion es recursiva, si hay mas intrucciones dbax, se llama a s� misma.
